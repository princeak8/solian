...
(function(k) {
    ...
    function Ab(a) {
        if (!u.__browser) {
            ...
            b.bScrollOversize =
                100 === f[0].offsetWidth && 100 !== d[0].clientWidth;
    ...
    function Hb(a) {
        ...
        for (
            var e = a.sDom.split(""), g, h, l, n, m, p, t = 0;
            t < e.length;
            t++
        ) {
            g = null;
    ...
    function pa(a) {
        ...
        for (a = 0; a < e.length; a++) {
            ...
            for (f = g.length; d < f; d++) {
                ...
                e[a]._idx === q &&
                    (e[a]._idx = k.inArray(e[a][1], c[l].asSorting));
                b.push({
                    src: h,
                    col: l,
                    dir: e[a][1],
    ...
    function bc(a, b) {
        ...
        for (
            ...
            if (
                ...
                (e = d ? f[h] : S(a, h, b, "sort")),
                    (c._aSortData[b] = g ? g(e) : e);
    }
    function Qa(a) {
    ...
    var u = function(a) {
            ...
            this.fnAddData = function(e, g) {
                ...
                e =
                    Array.isArray(e) &&
                    (Array.isArray(e[0]) || k.isPlainObject(e[0]))
                        ? h.rows.add(e)
                        : h.row.add(e);
                (g === q || g) && h.draw();
            ...
            this.fnGetPosition = function(e) {
                ...
                return "TR" == h
                    ...
                    : "TD" == h || "TH" == h
                    ? ((e = g.cell(e).index()),
                      [e.row, e.columnVisible, e.column])
                    : null;
            };
            ...
            return tb(
                ...
                function(f) {
                    ...
                    if (f.nodeName) {
                        ...
                        if (h)
                            return g[h.row] && g[h.row].nTr === f.parentNode
                                ? [h.row]
                                : [];
