 ...
 <div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Products-Gallery <a href="{{url('admin/product/create')}}" class="btn btn-sm btn-primary ml-3">Add Product</a></h6>
        </div>
        <div class="card-body">
            @if($products->count() > 0)
                <div class="row">
                    @foreach($products as $product)
                        <div class="col-3">
                            <img src="{{ $product->mainthumb }}" alt="" title="" style="width:100%; height:15em; object-fit: cover;" />
